...
import { validateFactura, validatePartialFactura } from "../validations/facturasValidator.mjs";
...
export class FacturasModel {
    ...
    static async getById({ id }) {
        const [result] = await db.query(
            ...
            FROM facturascompras_obra WHERE id = ?`, [id]
        );
    ...
    static async update({ id, input }) {
        ...
        const fields = Object.keys(valid).map(key => {
            switch (key) {
                case "idObra": return "id_obra = ?";
                case "idFacturasCompras": return "id_facturascompras = ?";
                case "fechaAlta": return "fecha_alta = ?";
                case "codigoUsuarioAlta": return "codigo_usuario_alta = ?";
                case "fechaActualizacion": return "fecha_actualizacion = ?";
                case "fechaBaja": return "fecha_baja = ?";
                case "codigoUsuarioBaja": return "codigo_usuario_baja = ?";
