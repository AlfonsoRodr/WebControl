...
export class FacturasController {
    ...
    static async update(req, res, next) {
        try {
            ...
            const facturaActualizada = await FacturasModel.update({ id: Number(id), input });
    ...
    static async delete(req, res, next) {
        try {
            ...
            const facturaEliminada = await FacturasModel.delete({ id: Number(id), codigoUsuarioBaja });
